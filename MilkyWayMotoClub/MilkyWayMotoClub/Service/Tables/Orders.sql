CREATE TABLE [Service].[Orders] (
    ...
    [Order_Service_Employee_Code] INT             NOT NULL,
    ...
    CONSTRAINT [OrderService_FK_Employee_Code] FOREIGN KEY ([Order_Service_Employee_Code]) REFERENCES [dbo].[Employees] ([Employee_Code]),
    UNIQUE NONCLUSTERED ([Order_Service_Code] ASC),
    UNIQUE NONCLUSTERED ([Order_Service_Employee_Code] ASC)
);
